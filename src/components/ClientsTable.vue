<template>
  <v-container>
    ...
    <v-dialog v-model="modalOpen">
      <ClientForm :editingMode="editingMode" :editedClientId="editedClientId" @client-added="handleClientAdded"
        @client-updated="handleClientUpdated" @cancel="closeModal" ref="clientForm" />
    </v-dialog>
  </v-container>
</template>
