  ...
  <v-card>
    ...
    <v-card-text>
      <v-form @submit.prevent="register">
        ...
        <v-text-field v-model="user.password" label="Hasło (min. 6 znaków)"
          :append-icon="user.showPassword ? 'mdi-eye' : 'mdi-eye-off'" :type="user.showPassword ? 'text' : 'password'"
          @click:append="user.showPassword = !user.showPassword"></v-text-field>
        <v-text-field v-model="user.confirmPassword" label="Potwierdź hasło"
          :append-icon="user.showConfirmPassword ? 'mdi-eye' : 'mdi-eye-off'"
          :type="user.showConfirmPassword ? 'text' : 'password'"
          @click:append="user.showConfirmPassword = !user.showConfirmPassword"></v-text-field>
        <v-card-actions>
